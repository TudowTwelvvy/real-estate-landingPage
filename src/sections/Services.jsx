        ...
        <div className="grid lg:grid-cols-3 grid-cols-1 justify-center items-center gap-8">
          {service.map((item, index) => (
            <div
              data-aos="zoom-in"
              data-aos-delay="200"
              className="bg-white dark:bg-black h-[350px] px-8 py-16 flex flex-col justify-center items-start gap-4 rounded-xl border-b-[5px] border-red-300 cursor-pointer"
              key={index}
            >
              ...
              <button className="border-b-2 border-red-600 text-red-600 p-0 font-semibold dark:text-white ">
                READ MORE
              </button>
            </div>
          ))}
